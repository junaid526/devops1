...
<nav style="border:none;margin-left:120px;padding-top:10px;background-color:transparent" class="navbar navbar-inverse">
 <ul class="nav navbar-nav">
    ...
    <div class="border">
    <center><h2 style="color:green"> My FRIENDS LIST</h2></center>
     			...
     			<tr style="color:white;">
     				...
     				<th style="color:red">GENDER</th>
     					...
     					<%
									...
									ResultSet rs = st.executeQuery("select name,gender from send_request where from_name='" + Username + "' or name='" + Username + "'");
									while(rs.next())
									{
									%>
