...
<th style="color:red">productname</th>
<th style="color:red">brandname</th>
<th style="color:red">Price</th>
<th style="color:red">warranty</th>
 ...
 <%
    ...
    String Username = (String)s.getAttribute("Username");
     ...
     ResultSet rs = st.executeQuery("select * from send_request as t1  join  sendrecom as t2 where t1.from_name=t2.from_name having name='"+ Username +"'");
     while(rs.next())
     {
     %>
