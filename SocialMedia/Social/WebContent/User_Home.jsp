...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div>
      <ul class="nav navbar-nav">
        <li class style="font-family: 'Indie+Flower';font-size:20px"><a href="home.jsp">Home</a></li>
 ...
 <h3 style="color:Navy;font-size:30px">Welcome <%=session.getAttribute("Username")%></h3>
...
<div style="height:430px"class="fb">

</div>

<script>
window.alert("WELCOME USER!!! you are logged in $ ")
</script>
</body>
</html>